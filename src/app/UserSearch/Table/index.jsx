...
import { TableWrapper, Head, Divider, Column, TableRows, SectionRow, Row, CircleUserIcon } from './StyledComponents';
...
export const Table = () => {
  const { usersData, userType, handleOpenDialog } = useContext(UserSearchContext);
